defmodule Tracms.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Tracms.Repo)
  ...
  @doc """
  A user changeset for profile and access metadata managed by administrators.
  """
  ...
  def approve_changeset(user) do
    change(user, status: :active, approved_at: DateTime.utc_now(:second))
  end
  ...
  """
  def valid_password?(%Tracms.Accounts.User{hashed_password: hashed_password}, password)
