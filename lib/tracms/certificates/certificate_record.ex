defmodule Tracms.Certificates.CertificateRecord do
  ...
  @verification_status_values [:active, :revoked]

  schema "certificate_records" do
    field :certificate_number, :string
    field :verification_code, :string
    field :verification_status, Ecto.Enum, values: @verification_status_values, default: :active
  ...
  def verification_status_values, do: @verification_status_values
  ...
  def changeset(certificate_record, attrs) do
    ...
    |> validate_length(:verification_code, min: 32, max: 120)
